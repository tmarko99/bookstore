...
public class CheckoutController {
    ...
    public String checkout(@PathVariable("id")Long cartId,
                           @PathVariable(value = "missingRequiredField", required = false)boolean missingRequiredField,
        ...
        if(cartItemList.size() == 0){
            ...
            return "forward:/shopingCart/cart";
        }
